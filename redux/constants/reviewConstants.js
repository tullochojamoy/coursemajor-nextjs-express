...
export const REVIEW_PURCHASED_LIST_REQUEST = 'REVIEW_PURCHASED_LIST_REQUEST'; 
export const REVIEW_PURCHASED_LIST_SUCCESS = 'REVIEW_PURCHASED_LIST_SUCCESS';
export const REVIEW_PURCHASED_LIST_FAIL = 'REVIEW_PURCHASED_LIST_FAIL';
...
export const REVIEW_UPDATE_REQUEST = 'REVIEW_CREATE_REQUEST'; 
export const REVIEW_UPDATE_SUCCESS = 'REVIEW_CREATE_SUCCESS';
export const REVIEW_UPDATE_FAIL = 'REVIEW_CREATE_FAIL';