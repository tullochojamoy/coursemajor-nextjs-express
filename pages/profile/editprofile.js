...
export default function EditProfile() {
    return (     
        <>
          <section className="u-align-center u-clearfix u-section-106" id="sec-791a">
            <div className="u-clearfix u-sheet u-sheet-1">
              <span className="u-icon u-icon-circle u-text-palette-1-base u-icon-1">
                <svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 55 55">
                  <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-c816"></use>
                </svg>
                <svg className="u-svg-content" viewBox="0 0 55 55" x="0px" y="0px" id="svg-c816" style={{enableBackground:"new 0 0 55 55"}}>
        ...
        c-0.252,0.137-0.502,0.297-0.752,0.476C5.276,41.792,2,35.022,2,27.5z">
              ...
              <h4 className="u-text u-text-default u-text-1"> Edit your User Profile</h4>
              ...
              <div className="u-form u-form-1">
                <form action="#" method="POST" className="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style={{padding: "10px"}}>
                  <div className="u-form-group u-form-partition-factor-2 u-form-group-1">
                    <label htmlFor="text-59d2" className="u-form-control-hidden u-label"></label>
                    <input type="text" placeholder="FIRST NAME" id="text-59d2" name="text-2" className="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"/>
                  </div>
                  <div className="u-form-group u-form-partition-factor-2 u-form-group-2">
                    ...
                    <input type="text" placeholder="LAST NAME" id="text-1b17" name="text" className="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"/>
                  </div>
                  <div className="u-form-group u-form-group-3">
                    <label htmlFor="text-a420" className="u-form-control-hidden u-label"></label>
                    <input type="text" id="text-a420" name="text-1" className="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" placeholder="EMAIL ADDRESS"/>
                  </div>
                  <div className="u-form-group u-form-group-4">
                    <label htmlFor="text-a475" className="u-form-control-hidden u-label"></label>
                    <input type="text" placeholder="PASSWORD" id="text-a475" name="text-3" className="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"/>
                  </div>
                  <div className="u-form-group u-form-group-5">
                    <label htmlFor="text-fcde" className="u-form-control-hidden u-label"></label>
                    <input type="text" placeholder="CONFIRM PASSWORD" id="text-fcde" name="text-4" className="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"/>
                  </div>
